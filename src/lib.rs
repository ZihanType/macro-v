...
//! ```
//!
//! But because of using `#[doc(hidden)]`, you must use `#[doc(inline)]`
//! attribute when re-exporting, otherwise re-exported macro won't be visible in
//! the document. When using `#[macro_v]`, `#[doc(inline)]` will be added
//! automatically, but if you want to re-export manually, you must remember to
//! add `#[doc(inline)]`, which is the only problem.
